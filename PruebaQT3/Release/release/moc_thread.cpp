...
QT_MOC_LITERAL(5, 52, 12)
    ...
    "Thread\0valueDisplayChanged\0\0UpdateParams\0"
    "DataParam*\0dataParamDlg\0"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->valueDisplayChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->UpdateParams((*reinterpret_cast< DataParam*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thread::valueDisplayChanged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Thread::valueDisplayChanged(int _t1)
{
